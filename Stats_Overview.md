...
* __Type I and Type II errors__ - two types of errors that we can make when testing hypothesis.  These two errors are linked; if we correct for one, the other is affected.
    ...
    - __Type II error (aka Statistical Power)__ - opposite of _Type I error_, occurs when we believe there is no effect in the population when in fact there is an effect.  The maximum acceptable probability of a _Type_II error_ is 20%_(aka //-level)_.  This means we miss 1 in 5 genuine effects.
